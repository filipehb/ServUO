        ...
        public override void OnComponentUsed(AddonComponent component, Mobile from)
        {
            ...
            if (comp != null && comp.Active)
            {
                if (comp.Offset.X == _Order[_Index])
                {
                    ...
                    _Fails = 0;
                    from.PrivateOverheadMessage(MessageType.Regular, 1154, 1157028, from.NetState); // *You activate the switch!*
                    ...
                    if (_Order.Count - 1 == _Index)
                    {
                        ...
                        if (KotlDoor.Instance != null)
                        {
                            ...
                            from.PrivateOverheadMessage(MessageType.Regular, 1154, 1157019, from.NetState); // *You hear a low hum as the door to the Time Room unseals...*
                ...
                else
                {
                    ...
                    from.PrivateOverheadMessage(MessageType.Regular, 1154, 1157029, from.NetState); // *The switch shorts out and electrocutes you! You are vulnerable to more energy damage in your shocked state!*

                    if (_Fails > 5 && _Fails > Utility.Random(15))
                    {
                        component.PrivateOverheadMessage(MessageType.Regular, 1154, 1157031, from.NetState); // *Circuit Fault! Generating new circuit sequence!*
                        Reset();
                    }
                }
            }
