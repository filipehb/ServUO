...
namespace Server.Spells
{
    public class Initializer
    {
        public static void Initialize()
        {
            ...
            Register(700, typeof(InspireSpell));
            Register(701, typeof(InvigorateSpell));
            Register(702, typeof(ResilienceSpell));
            Register(703, typeof(PerseveranceSpell));
            Register(704, typeof(TribulationSpell));
            Register(705, typeof(DespairSpell));

            Register(706, typeof(DeathRaySpell));
            Register(707, typeof(EtherealBurstSpell));
            Register(708, typeof(NetherBlastSpell));
            Register(709, typeof(MysticWeaponSpell));
            Register(710, typeof(CommandUndeadSpell));
            Register(711, typeof(ConduitSpell));
            Register(712, typeof(ManaShieldSpell));
            Register(713, typeof(SummonReaperSpell));
            Register(714, typeof(PassiveMasterySpell));
            Register(715, typeof(PassiveMasterySpell));
            Register(716, typeof(WarcrySpell));
            Register(717, typeof(PassiveMasterySpell));
            Register(718, typeof(RejuvinateSpell));
            Register(719, typeof(HolyFistSpell));
            Register(720, typeof(ShadowSpell));
            Register(721, typeof(WhiteTigerFormSpell));
            Register(722, typeof(FlamingShotSpell));
            Register(723, typeof(PlayingTheOddsSpell));
            Register(724, typeof(ThrustSpell));
            Register(725, typeof(PierceSpell));
            Register(726, typeof(StaggerSpell));
            Register(727, typeof(ToughnessSpell));
            Register(728, typeof(OnslaughtSpell));
            Register(729, typeof(FocusedEyeSpell));
            Register(730, typeof(ElementalFurySpell));
            Register(731, typeof(CalledShotSpell));
            Register(732, typeof(PassiveMasterySpell));
            Register(733, typeof(ShieldBashSpell));
            Register(734, typeof(BodyGuardSpell));
            Register(735, typeof(HeightenedSensesSpell));
            Register(736, typeof(ToleranceSpell));
            Register(737, typeof(InjectedStrikeSpell));
            Register(738, typeof(PassiveMasterySpell));
            Register(739, typeof(RampageSpell));
            Register(740, typeof(FistsOfFurySpell));
            Register(741, typeof(PassiveMasterySpell));
            Register(742, typeof(WhisperingSpell));
            Register(743, typeof(CombatTrainingSpell));
        }
