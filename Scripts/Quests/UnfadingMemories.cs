...
namespace Server.Engines.Quests
{
    ...
    public class UnfadingMemoriesThreeQuest : BaseQuest
    {
        ...
        public override object Complete => 1075378;
        public override void Serialize(GenericWriter writer)
        {
            base.Serialize(writer);
